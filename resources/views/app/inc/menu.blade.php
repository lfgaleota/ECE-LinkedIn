<nav id="menubar" class="top-bar">
  ...
  <div class="top-bar-right">
    <ul class="dropdown menu" data-dropdown-menu>
      ...
      <li><a href="#"><i class="fas fa-bell"></i><span class="badge">{{count(auth()->user()->unreadNotifications)}}</span></a>
    ...
    <li>
      <a href="{{ route( 'user.profile', [ 'username' => Auth::user()->username ] ) }}"><i class="fas fa-user-circle"></i></a>
      <ul class="menu vertical">
