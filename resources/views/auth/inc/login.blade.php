<div class="login-form">
    {!! Form::open(['route' => 'login']) !!}
        <div>
            {{ Form::label('username', 'Username or Email address', ['class' => ($errors->has('username') ? 'is-invalid-label' : '')]) }}
        ...
        <div class="grid-x grid-margin-x">
            ...
            <div class="cell auto">
                <div class="switch">
                    <input type="checkbox" id="remember" name="remember" class="switch-input" {{ old('remember') ? 'checked' : '' }}>
